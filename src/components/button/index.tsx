...
export const Button = ({
  ...
  return (
    <S.Button aria-label={label} href="/" size={size} colors={colors}>
      <span>{text}</span>
      {ArrowRight ? (
        <svg
          width="20"
